 ...
 * @author Eva
 */
public class ManageCinemaEmployeeJPanel extends javax.swing.JPanel {

    /**
     * Creates new form ManageCinemaEmployeeJPanel
     */
    JPanel workArea;
    FilmFactorySystem system;
    UserAccount cinemaAdmin;
    String enName;
    public ManageCinemaEmployeeJPanel(JPanel workArea, UserAccount cinemaAdmin, FilmFactorySystem system) {
        initComponents();
    ...
    private void initComponents() {
        ...
        lblTitle.setText("Manage Platform Employee");
        ...
        jLabel2.setText("Add New Platform Employee:");
        ...
        if (name.isEmpty() || pwd.isEmpty()) {
            ...
            for(Network network: system.getNetworkList()) {
                for(Enterprise enterprise: network.getEnterpriseDirectory().getEnterpriseList()) {
                    if (enterprise.getName().equals(enName)) {
                        for(Organization org: enterprise.getOrganizationDirectory().getOrganizationList()){
                            if (org.getName().equals("CinemaEmployeeOrg")) {
                                UserAccount cinemaEmployee = org.getUserAccountDirectory().createUserAccount(name, pwd, new CinemaEmployeeRole());
                                for(CinemaRequest crq: cinemaAdmin.getCinemaQueue().getCinemaRequestList()) {
                                    crq.addEmployee(cinemaEmployee);
                                    cinemaEmployee.getCinemaQueue().addCinemaRequest(crq);
                                }
