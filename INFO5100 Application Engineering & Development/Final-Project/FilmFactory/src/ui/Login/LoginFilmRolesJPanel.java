 ...
 * @author Eva
 */
public class LoginFilmRolesJPanel extends javax.swing.JPanel {

    /**
     * Creates new form LoginFilmRolesJPanel
     */
    JPanel mainWorkArea;
    FilmFactorySystem system;
    JPanel menuJPanel;
    public LoginFilmRolesJPanel(JPanel mainWorkArea, JPanel menuJPanel, FilmFactorySystem system) {
    ...
    private void initComponents() {
        ...
        lblTitle.setText("FilmRoles Login");
        ...
        for(Network network:system.getNetworkList()) {
            for (Enterprise enterprise:network.getEnterpriseDirectory().getEnterpriseList()) {
                for (Organization organization:enterprise.getOrganizationDirectory().getOrganizationList()) {
                    ...
                    if ((userAccount != null)&&((userAccount.getRole().toString().equals("FilmAdmin"))||(userAccount.getRole().toString().equals("FilmDirector"))||(userAccount.getRole().toString().equals("FilmScriptwriter"))||(userAccount.getRole().toString().equals("FilmCameraman")))){
                        CardLayout layout = (CardLayout) mainWorkArea.getLayout();
