 ...
 * @author Eva
 */
public class LoginReviewRolesJPanel extends javax.swing.JPanel {

    /**
     * Creates new form LoginReviewRolesJPanel
     */
    JPanel mainWorkArea;
    FilmFactorySystem system;
    JPanel menuJPanel;
    public LoginReviewRolesJPanel(JPanel mainWorkArea, JPanel menuJPanel, FilmFactorySystem system) {
    ...
    private void initComponents() {
        ...
        lblTitle.setText("ReviewRoles Login");
        ...
        for(Network network:system.getNetworkList()) {
            for (Enterprise enterprise:network.getEnterpriseDirectory().getEnterpriseList()) {
                for (Organization organization:enterprise.getOrganizationDirectory().getOrganizationList()) {
                    ...
                    if ((userAccount != null)&&((userAccount.getRole().toString().equals("ReviewAdmin"))||(userAccount.getRole().toString().equals("ReviewAuditor")))){
                        CardLayout layout = (CardLayout) mainWorkArea.getLayout();
