 ...
 * @author Eva
 */
public class ManageCinemaAdminJPanel extends javax.swing.JPanel {

    /**
     * Creates new form ManageCinemaRolesJPanel
     */
    JPanel workArea;
    FilmFactorySystem system;
    public ManageCinemaAdminJPanel(JPanel workArea, FilmFactorySystem system) {
        initComponents();
    ...
    private void initComponents() {
        ...
        lblTitle.setText("Manage PlatformAdmin");
        ...
        jLabel2.setText("Add New PlatformAdmin:");
    ...
    private void btnCreateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCreateActionPerformed
        ...
        int i =0;
        //JOptionPane.showMessageDialog(this, "breakPoint0");
        if (name.isEmpty() || pwd.isEmpty()) {
            ...
            for(Network network: system.getNetworkList()) {
               ...
               if(i==0){
                   Enterprise cinemaEn = network.getEnterpriseDirectory().createAndAddEnterprise(name, Enterprise.EnterpriseType.CinemaEn);
                   Organization cinemaOrg = cinemaEn.getOrganizationDirectory().createOrganization(Organization.Type.CinemaManager);
                   cinemaOrg.setName("CinemaOrg");
                   Organization cinemaEmployeeOrg = cinemaEn.getOrganizationDirectory().createOrganization(Organization.Type.CinemaEmployee);
                   cinemaEmployeeOrg.setName("CinemaEmployeeOrg");
                   UserAccount cinemaAdmin = cinemaOrg.getUserAccountDirectory().createUserAccount(name, pwd, new CinemaManagerRole());
