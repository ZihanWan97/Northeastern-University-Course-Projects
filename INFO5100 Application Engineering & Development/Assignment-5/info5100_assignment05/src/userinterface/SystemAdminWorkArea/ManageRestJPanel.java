...
public class ManageRestJPanel extends javax.swing.JPanel {
     ...
     */
    public ManageRestJPanel(JPanel userProcessContainer,EcoSystem ecosystem) {
        initComponents();
    ...
    private void initComponents() {
        ...
        lblNewManager = new javax.swing.JLabel();
        ...
        lblNewManager.setFont(new java.awt.Font("微软雅黑", 3, 12)); // NOI18N
        lblNewManager.setText("Add Restaurant Manager:");
        ...
        lblTitle.setText("Manage Restaurant Manager");
    ...
    private void btnCreateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCreateActionPerformed
        ...
        if (name.isEmpty() || pwd.isEmpty()) {
            ...
            ecosystem.getUserAccountDirectory().createUserAccount(name, pwd, null, new AdminRole());
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        if(row<0){
            JOptionPane.showMessageDialog(null, "Please select a restairant!", "Warning", JOptionPane.WARNING_MESSAGE);
            return;
        }
    ...
    private javax.swing.JLabel lblNewManager;
